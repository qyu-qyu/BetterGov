...
<div id="sidebar">
    ...
    <nav>
        <a href="{{ route('citizen.services.index') }}"     class="{{ request()->is('citizen/services*') && !request()->is('citizen/services/*/show') ? 'active' : '' }}">
            <i class="bi bi-grid-3x3-gap-fill"></i> Browse Services
        </a>
        <a href="{{ route('citizen.requests.index') }}"     class="{{ request()->is('citizen/requests*') ? 'active' : '' }}">
            <i class="bi bi-file-earmark-text-fill"></i> My Requests
        </a>
        <a href="{{ route('citizen.offices.index') }}"      class="{{ request()->is('citizen/offices*') ? 'active' : '' }}">
            <i class="bi bi-geo-alt-fill"></i> Find Offices
        </a>
        <a href="{{ route('citizen.appointments.index') }}" class="{{ request()->is('citizen/appointments*') ? 'active' : '' }}">
            <i class="bi bi-calendar-check-fill"></i> Appointments
        </a>
        <a href="{{ route('citizen.feedback.create') }}"    class="{{ request()->is('citizen/feedback*') ? 'active' : '' }}">
            <i class="bi bi-star-fill"></i> Feedback
        </a>
        <a href="{{ route('citizen.history.index') }}"      class="{{ request()->is('citizen/history*') ? 'active' : '' }}">
